...
//         const [freqLocation] = await pool.execute(getFreqLocationQuery, [freqLocationId, userId]);
...
//         const [result] = await pool.execute(updateFreqLocationQuery, [category, name, address, loc_id, freqLocationId, userId]);
...
//         const [result] = await pool.execute(deleteFreqLocationQuery, [freqLocationId, userId]);
